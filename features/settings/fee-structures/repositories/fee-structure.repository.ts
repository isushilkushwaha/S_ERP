...
//             },
//           },
//           installmentPlan: true, // <-- CRITICAL: Fetches the linked default installment plan
//         },
//       }),
...
//           },
//         },
//         installmentPlan: true, // <-- CRITICAL: Fetches linked plan when querying single record
//       },
//     });
    ...
    const [rawItems, total] = await Promise.all([
      prisma.feeStructure.findMany({
        ...
        include: {
          ...
          // IMPORTANT:
          // Include medium so frontend can display
          // ENGLISH / HINDI / BOTH correctly.
          class: {
            select: {
              id: true,
              name: true,
  ...
  async findById(
    ...
    const item = await prisma.feeStructure.findFirst({
      ...
      include: {
        ...
        // IMPORTANT:
        // Also include medium when fetching
